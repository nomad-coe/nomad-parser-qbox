...
<start_time> 2016-05-31T13:56:47Z </start_time>
...
[qbox] <cmd>load ../si4gs/test.xml</cmd>
 ...
 XMLGFPreprocessor: read time: 0.000102
 XMLGFPreprocessor: local read rate: 836.4 MB/s  aggregate read rate: 3346 MB/s
 XMLGFPreprocessor: tag fixing time: 7.319e-05
 XMLGFPreprocessor: segment definition time: 0.002065
 XMLGFPreprocessor: boundary adjustment time: 2.146e-06
 XMLGFPreprocessor: transcoding time: 4.053e-06
 XMLGFPreprocessor: data redistribution time: 0.000777
 XMLGFPreprocessor: XML compacting time: 0.0001709
 XMLGFPreprocessor: total time: 0.003742
...
SLA PZ NOGX NOGC
 ...
 XML parsing done
 SampleReader: read time: 0.03135 s
...
<unit_cell_volume> 4096.000 </unit_cell_volume>
  ...
  <timing name="iteration" min="    0.033" max="    0.034"/>
</iteration>
<iteration count="2">
  total_electronic_charge: 16.00000000
...
<unit_cell_volume> 4096.000 </unit_cell_volume>
  ...
  <etotal_int>     -15.37436292 </etotal_int>
  <timing name="iteration" min="    0.085" max="    0.085"/>
</iteration>
<iteration count="22">
  total_electronic_charge: 16.00000000
...
<unit_cell_volume> 4096.000 </unit_cell_volume>
  ...
  <etotal_int>     -15.37434395 </etotal_int>
  <timing name="iteration" min="    0.048" max="    0.048"/>
</iteration>
<iteration count="23">
  total_electronic_charge: 16.00000000
...
<unit_cell_volume> 4096.000 </unit_cell_volume>
  ...
  <timing name="iteration" min="    0.040" max="    0.043"/>
</iteration>
<iteration count="45">
  total_electronic_charge: 16.00000000
...
<unit_cell_volume> 4096.000 </unit_cell_volume>
  ...
  <timing name="iteration" min="    0.121" max="    0.122"/>
</iteration>
<iteration count="49">
  total_electronic_charge: 16.00000000
...
<unit_cell_volume> 4096.000 </unit_cell_volume>
  ...
  <timing name="iteration" min="    0.041" max="    0.041"/>
</iteration>
  total_electronic_charge: 16.00000000
  total_electronic_charge: 16.00000000
<timing name="          align" min="    0.009" max="    0.020"/>
<timing name="         charge" min="    0.467" max="    0.519"/>
<timing name="         energy" min="    0.657" max="    0.684"/>
<timing name="           gram" min="    0.001" max="    0.001"/>
<timing name="         lowdin" min="    0.009" max="    0.009"/>
<timing name="    ortho_align" min="    0.058" max="    0.075"/>
<timing name="      psda_prec" min="    0.004" max="    0.004"/>
<timing name="  psda_residual" min="    0.017" max="    0.043"/>
<timing name=" psda_update_wf" min="    0.005" max="    0.021"/>
<timing name="    update_vhxc" min="    0.367" max="    0.426"/>
<timing name="      wf_update" min="    0.120" max="    0.143"/>
<timing name="           ekin" min="    0.017" max="    0.047"/>
<timing name="            exc" min="    0.236" max="    0.269"/>
<timing name="           hpsi" min="    0.538" max="    0.540"/>
<timing name="       nonlocal" min="    0.091" max="    0.096"/>
<timing name=" charge_compute" min="    0.309" max="    0.328"/>
<timing name="charge_integral" min="    0.017" max="    0.035"/>
<timing name="  charge_rowsum" min="    0.004" max="    0.006"/>
<timing name="     charge_vft" min="    0.117" max="    0.163"/>
[qbox]  End of command stream 
<real_time> 1.944 </real_time>
<end_time> 2016-05-31T13:56:49Z </end_time>
</fpmd:simulation>
